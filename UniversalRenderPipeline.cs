...
namespace UnityEngine.Rendering.Universal
{
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        static void RenderCameraStack(ScriptableRenderContext context, Camera baseCamera)
        {
            ...
            //original code - RenderSingleCamera(context, baseCameraData, !isStackedRendering, anyPostProcessingEnabled);
            RenderSingleCamera(context, baseCameraData, true, anyPostProcessingEnabled);
			...
			overlayCameraData.isDefaultViewport = (!(Math.Abs(cameraRect.x) > 0.0f || Math.Abs(cameraRect.y) > 0.0f ||
				Math.Abs(cameraRect.width) < 1.0f || Math.Abs(cameraRect.height) < 1.0f));
                    ...
                    //original code - RenderSingleCamera(context, overlayCameraData, lastCamera, anyPostProcessingEnabled);
                    RenderSingleCamera(context, overlayCameraData, false, anyPostProcessingEnabled);
